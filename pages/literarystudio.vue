...
export default {
  ...
  mounted() {
    var self = this
    axios.get('https://pxpwk6ap0j.execute-api.ap-south-1.amazonaws.com/latest/roles/5ccffe70-f2b8-11e9-bba2-d1d49d62f296').then(res => {
      self.roles = res.data
    })
  }
}
...
.role {
  box-shadow: 1px -1px 10px 1px rgba(37, 36, 36, 0.85);
  padding: 30px;
  font-size: 2rem;
  border-radius: 5px;
}
